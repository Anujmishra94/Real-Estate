...
const Projects = () => {
  ...
  return (
    <div
      className="container mx-auto py-4 pt-17 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden text-center"
      id="Projects"
    >
      ...
      <p className="text-gray-500 mx-auto max-w-80 text-center mb-8">
        From Vision to Reality - Explore Our Portfolio
      </p>
      ...
      <div className="flex justify-end items-center mb-8">
        ...
        >
          <img src={assets.right_arrow} alt="Rigt" />
        </button>
      </div>
